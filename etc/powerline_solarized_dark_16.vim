...
" based on Stephen McKenney's https://github.com/stephenmckinney/vim-solarized-powerline
call Pl#Hi#Allocate({
	\ 'base03'         : [8, 0x002b36],
	\ 'base02'         : [0, 0x073642],
	\ 'base01'         : [10, 0x586e75],
...
let g:Powerline#Colorschemes#powerline_solarized_dark_16#colorscheme= Pl#Colorscheme#Init([
